...
class Config:
    ...
    # Packages for TPU-native training mode (torch-xla on TPU v5e)
    # NOTA: bitsandbytes es CUDA-only, no se incluye aquí.
    # Usamos cuantización 4-bit nativa implementada con operaciones XLA.
    TPU_VENV_PACKAGES: ClassVar[list[str]] = [
        "torch>=2.5.0",
        "torch-xla>=2.5.0",
        "torchvision",
        "transformers>=4.44.0",
    ...
    def from_env(cls) -> Config:
        ...
        env_map = {
            ...
            "SIA_TRAINING_BACKEND": ("TRAINING_BACKEND", str),
        }
    ...
    # Default training backend, overridable via CLI or env var
